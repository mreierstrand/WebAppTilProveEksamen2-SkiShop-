...
new Vue({
    ...
    methods: {
        ...
        addSki: function () {
            ...
            var addSkiLengthElement = document.getElementById("addSkiLength");
            var addSkiTypeElement = document.getElementById("addSkiType");
            var addPriceElement = document.getElementById("addPrice");
            var myskiID = Number(addIdElement.value);
            var myskiLength = Number(addSkiLengthElement.value);
            var myskiType = addSkiTypeElement.value;
            var myskiPrice = Number(addPriceElement.value);
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, { id: myskiID, skiLength: myskiLength, skiType: myskiType, price: myskiPrice })
                .then(function (response) {
